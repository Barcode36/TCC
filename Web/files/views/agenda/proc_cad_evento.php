<?php
    ...
    if(!empty($titulo) && !empty($descricao) && !empty($start) && !empty($end)){
        ...
        //Inserindo as informações no Banco de Dados ****LocalHost*****
        $rest = 'http://localhost/TCC/api/eventPers/inserir/' . $titulo2 . '/' . $start_sem_barra . '/' . $end_sem_barra . '/' . $descricao2 . '/' . $_SESSION['codigo'] . '/1';
